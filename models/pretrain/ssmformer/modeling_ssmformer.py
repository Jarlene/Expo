...
from layer.layers import RMSNorm, RotaryEmbedding, LinearScalingRotaryEmbedding, DynamicNTKScalingRotaryEmbedding, YaRNScaledRotaryEmbedding, DynamicYaRNScaledRotaryEmbedding
from layer.moe.moe import SoftMoE, DroplessMoE
...
class DecoderLayer(nn.Module):
    def __init__(self, config: SSMFormerConfig, layer_idx: Optional[int] = None):
        ...
        expert = Mamba(dim=config.hidden_size, d_state=config.d_state,
    ...
    def forward(
        ...
        auxiliary_loss: Optional[bool] = True,
        padding_mask: Optional[torch.Tensor] = None,
        ...
        if isinstance(hidden_states, tuple):
            ...
            auxiliary_loss = hidden_states[1] + hidden_states[2]
